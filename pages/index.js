      ...
      <div className="flex min-h-screen mx-auto items-center justify-center">
        <div className="flex-col justify-center items-center">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="p-5 bg-violet-500 text-white rounded-lg flex justify-center items-center cursor-pointer hover:shadow-md hover:bg-violet-600 cursor-not-allowed">

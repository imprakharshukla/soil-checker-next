...
function DropzoneComp({testName, setRespose}) {
                ...
                <div>
                    ...
                    <div className="flex justify-center items-center space-x-5">
                        <button
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    const resp = await identifySoil({image: blob, testName: testName})
                                    setRespose(resp)
                                } catch (e) {
                                    console.log(e)
                                }
                            ...
                            className="transition shadow-md duration-150 ease-in-out hover:-translate-y-1 w-fit mt-6 px-4 py-2 bg-violet-500 text-white rounded-md flex justify-center items-center">
                            {isLoading &&
                                <svg
                        ...
                        <button
                            ...
                            className="transition shadow-md duration-150 ease-in-out hover:-translate-y-1 w-fit mt-6 px-4 py-2 bg-white font-semibold
